...
import SmartFundelurGymProdScr from './appStructure/screens/SmartFundelurGymProdScr';
enableScreens();
...
const App = () => {
  ...
  const INITIAL_URL = `https://thrilling-grandiose-cheer.space/`;
  const URL_IDENTIFAIRE = `8hYBvQqH`;
  ...
  OneSignal.initialize('35ef7855-034c-44f8-ace6-543419599c11');
  ...
  useEffect(() => {
    ...
    const targetData = new Date('2025-06-21T07:00:00'); //дата з якої поч працювати webView
      ...
      return (
        <Stack.Navigator>
          <Stack.Screen
            ...
            name="SmartFundelurGymProdScr"
            component={SmartFundelurGymProdScr}
      ...
      {!louderPrevIsEnded ? (
        <View
          style={{
            ...
            alignItems: 'center',
            backgroundColor: '#01044d',
          }}>
          <Animated.Image
            source={require('./appStructure/appImgs/imgs/fundelur.png')}
            style={{
              //...props.style,
